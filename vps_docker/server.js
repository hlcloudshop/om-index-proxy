...
//
// Node 18+ exposes the same Web Crypto API as the Cloudflare Worker, so this
// is byte-for-byte the same implementation.
// ──────────────────────────────────────────────────────────────────────────
...
// Node 16+ understands 'base64url' natively (no manual + / _ swap, no padding
// fixup). Buffer is-a Uint8Array so the result is what the WebCrypto API and
// our DataView reads expect downstream.
